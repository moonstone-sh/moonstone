...
pub const assets = struct {
    ...
    pub const raw = struct {
        ...
        pub const templates = struct {
            ...
            pub const nvim_partiture = @embedFile("assets/templates/nvim/partiture.lua");
            pub const nvim_minimal_init = @embedFile("assets/templates/nvim/minimal_init.lua");
            pub const nvim_doc = @embedFile("assets/templates/nvim/doc.txt");
            pub const nvim_readme = @embedFile("assets/templates/nvim/README.md");
            ...
            pub const lua_zig_main = @embedFile("assets/templates/lua-zig/src/main.lua");
            pub const lua_zig_app = @embedFile("assets/templates/lua-zig/src/app.lua");
            pub const lua_zig_bridge = @embedFile("assets/templates/lua-zig/native/src/bridge.zig");
            pub const lua_zig_build = @embedFile("assets/templates/lua-zig/build.zig");
            pub const lua_zig_luarc = @embedFile("assets/templates/lua-zig/luarc.json");
            pub const lua_zig_readme = @embedFile("assets/templates/lua-zig/README.md");
            pub const meteorite_main = @embedFile("assets/templates/meteorite/src/main.lua");
            pub const meteorite_app = @embedFile("assets/templates/meteorite/src/app.lua");
            pub const meteorite_handlers = @embedFile("assets/templates/meteorite/native/src/handlers.zig");
            pub const meteorite_validators = @embedFile("assets/templates/meteorite/native/src/validators.zig");
            pub const meteorite_native_main = @embedFile("assets/templates/meteorite/native/src/main.zig");
            pub const meteorite_build = @embedFile("assets/templates/meteorite/build.zig");
