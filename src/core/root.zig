...
pub const domain = struct {
    ...
    pub const manifest_protocol = @import("domain/manifest_protocol.zig");
    pub const script = @import("domain/script.zig");
    pub const semver = @import("domain/semver.zig");
    pub const lockfile = @import("domain/lockfile.zig");
    pub const lock_protocol = @import("domain/lock_protocol.zig");
...
pub const assets = struct {
    ...
    pub const raw = struct {
        ...
        pub const templates = struct {
            ...
            pub const lua_zig_bridge = @embedFile("assets/templates/lua-zig/zig/bridge.zig");
